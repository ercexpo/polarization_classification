...
#encode inputs using XLMRoberta tokenizer
input_ids = []
val_input_ids = []

for comment in comments_mod:
...
for comment in val_comments_mod:
    encoded_comment = tokenizer.encode(comment, add_special_tokens = True, max_length=512,pad_to_max_length=True,truncation=True)
...
# here.
# For fine-tuning XLMRoberta on a specific task, the authors recommend a batch size of
# 16 or 32.
...
for epoch_i in range(0, epochs):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        # https://huggingface.co/transformers/v2.2.0/model_doc/bert.html#transformers.XLMRobertaForSequenceClassification
